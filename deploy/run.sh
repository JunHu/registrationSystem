...
if [ $1 = 'start' ];then
    ...
    sudo cp registrationSystem_server /etc/nginx/sites-available/registrationSystem_server
    sudo ln -s /etc/nginx/sites-available/registrationSystem_server /etc/nginx/sites-enabled/registrationSystem_server
    sudo cp registrationSystem.ini /etc/uwsgi/apps-available/
